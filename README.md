...
1. **Data Manipulation & Synthetic Data Generation**  
   - Generate realistic synthetic conversation data  
   - Clean, preprocess, and analyze datasets  

2. **Model Training, Evaluation & Alternative Approaches**  
   - Train baseline and advanced ML / LLM-based models  
   - Evaluate and compare performance  

3. **Implementation, Testing & Fine-Tuning**  
